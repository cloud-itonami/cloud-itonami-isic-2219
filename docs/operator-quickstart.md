# Operator Quickstart — Manufacture of Other Rubber Products

Shortest path from clone to a verified local dry-run for **ISIC 2219** (`cloud-itonami-isic-2219`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2219.git
cd cloud-itonami-isic-2219
```
...
- Blueprint governor key: `compression-seal-governor`
- Likely source path: `rubberworks.governor.cljc`
